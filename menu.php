...
<html lang="es">
	<head>
		...
		<script type="text/javascript"> //agrega
			history.forward();
		</script>
		<link rel="stylesheet" href="css/bootstrap.min.css">
		<link rel="icon" href="img/logoOr.jpg"> <!--agrega-->
		<style media="screen">
		footer {
			width: 100%;
			background: #cfcfcf;
    ...
    <div id="cabecera_izquierda">
          <img src="img/titulo2.png" width="100%" id="header">
    </div>

		<div class="container col-sm-12">
			<div class="form-group row">
				<div class="col-sm-12">
				<p align="right"><a style="color:#FF5A43" href="login.php"><span class="glyphicon glyphicon-log-in"></span><strong>Salir</strong></a></p> <!--cambio-->
				</div>
								...
								<div class="col-sm-2">
									...
									<select class="form-control" name="search_proyecto" id="search_proyecto">
										...
										<?php if ($totalproy>0) { ?>
											<?php do { ?>
												<?php
													echo '<option>'.trim(utf8_encode($filaproy['ClaveProyecto'])).'</option>'; //cambio (utf8_encode())
												?>
								...
								<?php
									...
									if ($_GET["TipoCuentaUser"]=='admin'){
										$consultarea = "SELECT DISTINCT Area FROM actividades ORDER BY ClaveProyecto DESC";
											...
											$consultarea = "SELECT DISTINCT Area FROM actividades WHERE Area='$Area' ORDER BY Area DESC";
										}
								...
								<div class="col-sm-2">
									...
									<select class="form-control" name="search_area" id="search_area">
										...
										<?php if ($totalarea>0) { ?>
											<?php do { ?>
													<?php
														echo '<option>'.trim(utf8_encode($filaarea['Area'])).'</option>'; //cambio (utf8_encode())
													?>
									...
									<div class="col-lg-12 mx-auto bg-light text-dark rounded shadow">
										...
										<div class="table-responsive">
											...
											<div class="tableFixHead">
												<table id="tabla" class="table table-bordered table-striped mb-0 table-wrapper-scroll-y my-custom-scrollbar"> <!--cambio (se le arega ~id="tabla"~, para que sea reconocido desde el script dentro de buscador.php)-->
													...
													<tbody>
														...
														<tr>
															...
															<td><font size="-1"><?php echo utf8_encode($fila['Actividad']);?></font></td> <!--cambio (utf8_encode)-->
															...
															<?php
																if ($numerod<=5 and $signo=="+" and trim($fila['EstadoDeLaActividad'])=='ABIERTA'):
																	echo "<td style='text-align:center;'><img src='img/ico-reloj-amarillo.png' height='38' width='36'></td>";
																	elseif ($numerod>=5 and $signo=="+" and trim($fila['EstadoDeLaActividad'])=='ABIERTA'):
																		echo "<td style='text-align:center;'><img src='img/ico-reloj-azul.png' height='38' width='35'></td>";
																	elseif ($signo=="-" and trim($fila['EstadoDeLaActividad'])!='CERRADA'):
															...
															<td style="text-align:left;"><font size="-1"><?php echo utf8_encode($fila['Notas']);?></font></td> <!--cambio (utf8_encode)-->
															...
															<td style="text-align:left;"><font size="-1"><?php echo utf8_encode($fila['Area']);?></font></td> <!--cambio (utf8_encode)-->
														</tr><!-- tr into do -->
